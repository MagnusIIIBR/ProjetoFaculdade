...
(function (t, e, i) {
    "use strict";
    var n = t.UIkit || {}, o = t("html"), s = t(window);
    n.fn || (n.version = "2.3.1", n.fn = function (e, i) {
        var o = arguments, s = e.match(/^([a-z\-]+)(?:\.([a-z]+))?/i), a = s[1], r = s[2];
        return n[a] ? this.each(function () {
            var e = t(this), s = e.data(a);
            s || e.data(a, s = new n[a](this, r ? void 0 : i)), r && s[r].apply(s, Array.prototype.slice.call(o, 1))
        ...
        return t && {end: t}
    }(), n.support.requestAnimationFrame = i.requestAnimationFrame || i.webkitRequestAnimationFrame || i.mozRequestAnimationFrame || i.msRequestAnimationFrame || i.oRequestAnimationFrame || function (t) {
            i.setTimeout(t, 1e3 / 60)
        }, n.support.touch = "ontouchstart" in window && navigator.userAgent.toLowerCase().match(/mobile|tablet/) || i.DocumentTouch && document instanceof i.DocumentTouch || i.navigator.msPointerEnabled && i.navigator.msMaxTouchPoints > 0 || i.navigator.pointerEnabled && i.navigator.maxTouchPoints > 0 || !1, n.support.mutationobserver = i.MutationObserver || i.WebKitMutationObserver || i.MozMutationObserver || null, n.Utils = {}, n.Utils.debounce = function (t, e, i) {
        var n;
        return function () {
    ...
    }, n.Utils.isInView = function (e, i) {
        var n = t(e);
        if (!n.is(":visible"))return !1;
        var o = s.scrollLeft(), a = s.scrollTop(), r = n.offset(), l = r.left, u = r.top;
        return i = t.extend({
            topoffset: 0,
            leftoffset: 0
        }, i), u + n.height() >= a && u - i.topoffset <= a + s.height() && l + n.width() >= o && l - i.leftoffset <= o + s.width() ? !0 : !1
    }, n.Utils.options = function (e) {
        if (t.isPlainObject(e))return e;
        var i = e ? e.indexOf("{") : -1, n = {};
        if (-1 != i)try {
            n = Function("", "var json = " + e.substr(i) + "; return JSON.parse(JSON.stringify(json));")()
        } catch (o) {
        }
        return n
    }, n.Utils.events = {}, n.Utils.events.click = n.support.touch ? "tap" : "click", t.UIkit = n, t.fn.uk = n.fn, t.UIkit.langdirection = "rtl" == o.attr("dir") ? "right" : "left", t(function () {
        if (t(e).trigger("uk-domready"), n.support.mutationobserver) {
            var i = new n.support.mutationobserver(n.Utils.debounce(function () {
                t(e).trigger("uk-domready")
            }, 300));
            i.observe(document.body, {childList: !0, subtree: !0}), n.support.touch
        }
    }), o.addClass(n.support.touch ? "uk-touch" : "uk-notouch"))
})(jQuery, document, window), function (t, e) {
    "use strict";
    var i = t(window), n = "resize orientationchange", o = function (s, a) {
        var r = this, l = t(s);
    ...
    t.extend(o.prototype, {
        process: function () {
            var e = this;
            this.revert();
            var i = !1, n = this.columns.filter(":visible:first"), o = n.length ? n.offset().top : !1;
    ...
    }), o.defaults = {cls: "uk-margin-small-top"}, e.stackMargin = o, t(document).on("uk-domready", function () {
    ...
    function o() {
        a && clearTimeout(a), r && clearTimeout(r), l && clearTimeout(l), u && clearTimeout(u), a = r = l = u = null, d = {}
    }
    ...
    t(function () {
        ...
        "MSGesture" in window && (c = new MSGesture, c.target = document.body), t(document).bind("MSGestureEnd", function (t) {
            ...
            ("MSPointerDown" != e.type || s(e.originalEvent)) && (m = "MSPointerDown" == e.type ? e : e.originalEvent.touches[0], f = Date.now(), p = f - (d.last || f), d.el = t("tagName" in m.target ? m.target : m.target.parentNode), a && clearTimeout(a), d.x1 = m.pageX, d.y1 = m.pageY, p > 0 && 250 >= p && (d.isDoubleTap = !0), d.last = f, u = setTimeout(i, h), c && "MSPointerDown" == e.type && c.addPointer(e.originalEvent.pointerId))
        }).on("touchmove MSPointerMove", function (t) {
            ("MSPointerMove" != t.type || s(t.originalEvent)) && (m = "MSPointerMove" == t.type ? t : t.originalEvent.touches[0], n(), d.x2 = m.pageX, d.y2 = m.pageY, g += Math.abs(d.x1 - d.x2), v += Math.abs(d.y1 - d.y2))
        }).on("touchend MSPointerUp", function (i) {
            ("MSPointerUp" != i.type || s(i.originalEvent)) && (n(), d.x2 && Math.abs(d.x1 - d.x2) > 30 || d.y2 && Math.abs(d.y1 - d.y2) > 30 ? l = setTimeout(function () {
                d.el.trigger("swipe"), d.el.trigger("swipe" + e(d.x1, d.x2, d.y1, d.y2)), d = {}
            }, 0) : "last" in d && (isNaN(g) || 30 > g && 30 > v ? r = setTimeout(function () {
                var e = t.Event("tap");
                e.cancelTouch = o, d.el.trigger(e), d.isDoubleTap ? (d.el.trigger("doubleTap"), d = {}) : a = setTimeout(function () {
                    a = null, d.el.trigger("singleTap"), d = {}
                }, 250)
            }, 0) : d = {}, g = v = 0))
    ...
    t.extend(n.prototype, {
        remainIdle: !1, show: function () {
            ...
            if (this.dropdown.length) {
                var e = this.dropdown.css("margin-" + t.UIkit.langdirection, "").css("min-width", ""), i = e.show().offset(), n = e.outerWidth(), o = this.boundary.width(), s = this.boundary.offset() ? this.boundary.offset().left : 0;
                if (this.centered && (e.css("margin-" + t.UIkit.langdirection, -1 * (parseFloat(n) / 2 - e.parent().width() / 2)), i = e.offset(), (n + i.left > o || 0 > i.left) && (e.css("margin-" + t.UIkit.langdirection, ""), i = e.offset())), this.justified && this.justified.length) {
                    ...
                    if (e.css("min-width", a), "right" == t.UIkit.langdirection) {
                        var r = o - (this.justified.offset().left + a), l = o - (e.offset().left + e.outerWidth());
    ...
    }), n.defaults = {mode: "hover", remaintime: 800, justify: !1, boundary: t(window)}, e.dropdown = n;
    ...
    t.extend(o.prototype, {
        match: function () {
            ...
            if (e.length) {
                var i = Math.ceil(100 * parseFloat(e.css("width")) / parseFloat(e.parent().css("width"))) >= 100 ? !0 : !1, n = 0;
                if (!i)return this.elements.each(function () {
                    n = Math.max(n, t(this).outerHeight())
                }).each(function () {
                    var e = t(this), i = n - (e.outerHeight() - e.height());
    ...
    s.defaults = {cls: "uk-grid-margin"}, e.gridMatchHeight = o, e.gridMargin = s, t(document).on("uk-domready", function () {
    ...
    var o = !1, s = t("html"), a = '<div class="uk-modal"><div class="uk-modal-dialog"></div></div>', r = function (i, n) {
        var o = this;
        this.element = t(i), this.options = t.extend({}, r.defaults, n), this.transition = e.support.transition, this.dialog = this.element.find(".uk-modal-dialog"), this.element.on("click", ".uk-modal-close", function (t) {
    ...
    t.extend(r.prototype, {
        transition: !1, toggle: function () {
            return this[this.isActive() ? "hide" : "show"](), this
        }, show: function () {
            return this.isActive() ? void 0 : (o && o.hide(!0), this.resize(), this.element.removeClass("uk-open").show(), o = this, s.addClass("uk-modal-page").height(), this.element.addClass("uk-open").trigger("uk.modal.show"), this)
        }, hide: function (t) {
            if (this.isActive()) {
            ...
            var t = parseInt(this.dialog.css("width"), 10), e = t + parseInt(this.dialog.css("margin-left"), 10) + parseInt(this.dialog.css("margin-right"), 10) < i.width();
            this.dialog.css("margin-left", t && e ? -1 * Math.ceil(t / 2) : "")
        }, _hide: function () {
            this.element.hide().removeClass("uk-open"), s.removeClass("uk-modal-page"), o === this && (o = !1), this.element.trigger("uk.modal.hide")
        }, isActive: function () {
            return o == this
        }
    }), r.defaults = {keyboard: !0, show: !1, bgclose: !0};
    var l = function (e, i) {
        var n = this, o = t(e);
        o.data("modal") || (this.options = t.extend({target: o.is("a") ? o.attr("href") : !1}, i), this.element = o, this.modal = new r(this.options.target, i), o.on("click", function (t) {
    ...
    l.dialog = function (e, i) {
        var o = new r(t(a).appendTo("body"), i);
    ...
    }, l.alert = function (e, i) {
        l.dialog(['<div class="uk-margin">' + (e + "") + "</div>", '<button class="uk-button uk-button-primary uk-modal-close">Ok</button>'].join(""), t.extend({
            bgclose: !1,
            keyboard: !1
        }, i)).show()
    }, l.confirm = function (e, i, n) {
        i = t.isFunction(i) ? i : function () {
        };
        var o = l.dialog(['<div class="uk-margin">' + (e + "") + "</div>", '<button class="uk-button uk-button-primary js-modal-confirm">Ok</button> <button class="uk-button uk-modal-close">Cancel</button>'].join(""), t.extend({
            bgclose: !1,
            keyboard: !1
        }, n));
    ...
    }, l.Modal = r, e.modal = l, t(document).on("click.modal.uikit", "[data-uk-modal]", function () {
        var i = t(this);
        if (!i.data("modal")) {
            var n = new l(i, e.Utils.options(i.attr("data-uk-modal")));
            n.show()
        }
    ...
    "use strict";
    var i, n = t(window), o = t(document), s = {
        show: function (e) {
            if (e = t(e), e.length) {
                var a = t("html"), r = e.find(".uk-offcanvas-bar:first"), l = "right" == t.UIkit.langdirection, u = (r.hasClass("uk-offcanvas-bar-flip") ? -1 : 1) * (l ? -1 : 1), c = -1 == u && n.width() < window.innerWidth ? window.innerWidth - n.width() : 0;
                i = {x: window.scrollX, y: window.scrollY}, e.addClass("uk-active"), a.css({
                ...
                }), o.on("keydown.offcanvas", function (t) {
                    27 === t.keyCode && s.hide()
                })
            }
        }, hide: function (e) {
            var n = t("html"), s = t(".uk-offcanvas.uk-active"), a = "right" == t.UIkit.langdirection, r = s.find(".uk-offcanvas-bar:first");
        ...
        var n = this, o = t(e);
        o.data("offcanvas") || (this.options = t.extend({target: o.is("a") ? o.attr("href") : !1}, i), this.element = o, o.on("click", function (t) {
    ...
    function i(e) {
        var i = t(e), n = "auto";
        if (i.is(":visible"))n = i.outerHeight(); else {
            var o = {position: i.css("position"), visibility: i.css("visibility"), display: i.css("display")};
            n = i.css({position: "absolute", visibility: "hidden", display: "block"}).outerHeight(), i.css(o)
        }
        return n
    }
    ...
    var n = function (e, i) {
        var o = this, s = t(e);
        s.data("nav") || (this.options = t.extend({}, n.defaults, i), this.element = s.on("click", this.options.toggler, function (e) {
            e.preventDefault();
            var i = t(this);
            o.open(i.parent()[0] == o.element[0] ? i : i.parent("li"))
        }), this.element.find(this.options.lists).each(function () {
            var e = t(this), i = e.parent(), n = i.hasClass("uk-active");
    ...
    t.extend(n.prototype, {
        open: function (e, n) {
            ...
            }), s.toggleClass("uk-open"), s.data("list-container") && (n ? s.data("list-container").stop().height(s.hasClass("uk-open") ? "auto" : 0) : s.data("list-container").stop().animate({height: s.hasClass("uk-open") ? i(s.data("list-container").find("ul:first")) : 0}))
        }
    }), n.defaults = {
    ...
    t.extend(s.prototype, {
        tip: "", show: function () {
            if (o && clearTimeout(o), this.tip.length) {
                ...
                var e = this, i = t.extend({}, this.element.offset(), {
                    width: this.element[0].offsetWidth,
                    height: this.element[0].offsetHeight
                }), s = n[0].offsetWidth, a = n[0].offsetHeight, r = "function" == typeof this.options.offset ? this.options.offset.call(this.element) : this.options.offset, l = "function" == typeof this.options.pos ? this.options.pos.call(this.element) : this.options.pos, u = {
                    display: "none",
                    visibility: "visible",
                ...
                var d = {
                    bottom: {top: i.top + i.height + r, left: i.left + i.width / 2 - s / 2},
                    top: {top: i.top - a - r, left: i.left + i.width / 2 - s / 2},
                    left: {top: i.top + i.height / 2 - a / 2, left: i.left - s - r},
                    right: {top: i.top + i.height / 2 - a / 2, left: i.left + i.width + r}
                };
                t.extend(u, d[c[0]]), 2 == c.length && (u.left = "left" == c[1] ? i.left : i.left + i.width - s);
                var h = this.checkBoundary(u.left, u.top, s, a);
                if (h) {
                    switch (h) {
                        case"x":
                    ...
                    c = l.split("-"), t.extend(u, d[c[0]]), 2 == c.length && (u.left = "left" == c[1] ? i.left : i.left + i.width - s)
                }
                u.left -= t("body").position().left, o = setTimeout(function () {
                    n.css(u).attr("class", "uk-tooltip uk-tooltip-" + l), e.options.animation ? n.css({
                        opacity: 0,
                        display: "block"
                    }).animate({opacity: 1}, parseInt(e.options.animation, 10) || 400) : n.show(), o = !1
    ...
    var i = function (e, n) {
        var o = this, s = t(e);
        if (!s.data("switcher")) {
            if (this.options = t.extend({}, i.defaults, n), this.element = s.on("click", this.options.toggler, function (t) {
                    t.preventDefault(), o.show(this)
                }), this.options.connect) {
                this.connect = t(this.options.connect).find(".uk-active").removeClass(".uk-active").end();
                var a = this.element.find(this.options.toggler), r = a.filter(".uk-active");
                r.length ? this.show(r) : (r = a.eq(0), r.length && this.show(r))
            }
    ...
    t.extend(i.prototype, {
        show: function (e) {
            e = isNaN(e) ? t(e) : this.element.find(this.options.toggler).eq(e);
            var i = e;
            if (!i.hasClass("uk-disabled")) {
                if (this.element.find(this.options.toggler).filter(".uk-active").removeClass("uk-active"), i.addClass("uk-active"), this.options.connect && this.connect.length) {
                    var n = this.element.find(this.options.toggler).index(i);
                    this.connect.children().removeClass("uk-active").eq(n).addClass("uk-active")
                }
                this.element.trigger("uk.switcher.show", [i])
            }
        }
    }), i.defaults = {connect: !1, toggler: ">*"}, e.switcher = i, t(document).on("uk-domready", function () {
    ...
    var i = function (e, n) {
        ...
        if (!s.data("tab")) {
            ...
            var r = t('<li class="uk-tab-responsive uk-active"><a href="javascript:void(0);"></a></li>'), l = r.find("a:first"), u = t('<div class="uk-dropdown uk-dropdown-small"><ul class="uk-nav uk-nav-dropdown"></ul><div>'), c = u.find("ul");
            l.html(this.element.find("li.uk-active:first").find("a").text()), this.element.hasClass("uk-tab-bottom") && u.addClass("uk-dropdown-up"), this.element.hasClass("uk-tab-flip") && u.addClass("uk-dropdown-flip"), this.element.find("a").each(function (e) {
                var i = t(this).parent(), n = t('<li><a href="javascript:void(0);">' + i.text() + "</a></li>").on("click", function () {
            ...
            }), r.append(u).uk("dropdown", {mode: "click"}), this.element.append(r).data({
    ...
    i.defaults = {connect: !1}, e.tab = i, t(document).on("uk-domready", function () {
    ...
    var i = {}, n = function (e, o) {
        var s = this, a = t(e);
        a.data("search") || (this.options = t.extend({}, n.defaults, o), this.element = a, this.timer = null, this.value = null, this.input = this.element.find(".uk-search-field"), this.form = this.input.length ? t(this.input.get(0).form) : t(), this.input.attr("autocomplete", "off"), this.input.on({
            keydown: function (t) {
                if (s.form[s.input.val() ? "addClass" : "removeClass"](s.options.filledClass), t && t.which && !t.shiftKey)switch (t.which) {
                    case 13:
                        s.done(s.selected), t.preventDefault();
                        break;
                    case 38:
                        s.pick("prev"), t.preventDefault();
                        break;
                    case 40:
                        s.pick("next"), t.preventDefault();
                        break;
                    case 27:
                    case 9:
                        s.hide();
            ...
            s.form.removeClass("uk-open").removeClass("uk-loading").removeClass("uk-active"), s.value = null, s.input.focus()
        }), this.dropdown = t('<div class="uk-dropdown uk-dropdown-search"><ul class="uk-nav uk-nav-search"></ul></div>').appendTo(this.form).find(".uk-nav-search"), this.options.flipDropdown && this.dropdown.parent().addClass("uk-dropdown-flip"), this.dropdown.on("mouseover", ">li", function () {
            s.pick(t(this))
        }), this.renderer = new i[this.options.renderer](this), this.element.data("search", this))
    };
    t.extend(n.prototype, {
        request: function (e) {
            var i = this;
            this.form.addClass(this.options.loadingClass), this.options.source ? t.ajax(t.extend({
                url: this.options.source,
                type: this.options.method,
                dataType: "json",
                success: function (t) {
                    t = i.options.onLoadedResults.apply(this, [t]), i.form.removeClass(i.options.loadingClass), i.suggest(t)
                }
            }, e)) : this.form.removeClass(i.options.loadingClass)
        }, pick: function (t) {
            var e = !1;
            if ("string" == typeof t || t.hasClass(this.options.skipClass) || (e = t), "next" == t || "prev" == t) {
                var i = this.dropdown.children().filter(this.options.match);
                if (this.selected) {
                    var n = i.index(this.selected);
                    e = "next" == t ? i.eq(i.length > n + 1 ? n + 1 : 0) : i.eq(0 > n - 1 ? i.length - 1 : n - 1)
                } else e = i["next" == t ? "first" : "last"]()
            }
            e && e.length && (this.selected = e, this.dropdown.children().removeClass(this.options.hoverClass), this.selected.addClass(this.options.hoverClass))
        }, trigger: function () {
            var t = this, e = this.value, i = {};
            return this.value = this.input.val(), this.value.length < this.options.minLength ? this.hide() : (this.value != e && (this.timer && window.clearTimeout(this.timer), this.timer = window.setTimeout(function () {
                i[t.options.param] = t.value, t.request({data: i})
            }, this.options.delay, this)), this)
        }, done: function (t) {
            this.renderer.done(t)
        }, suggest: function (t) {
            t && (t === !1 ? this.hide() : (this.selected = null, this.dropdown.empty(), this.renderer.suggest(t), this.show()))
        }, show: function () {
    ...
    var o = function (e) {
        this.search = e, this.options = t.extend({}, o.defaults, e.options)
    };
    t.extend(o.prototype, {
        done: function (t) {
            return t ? (t.hasClass(this.options.moreResultsClass) ? this.search.form.submit() : t.data("choice") && (window.location = t.data("choice").url), this.search.hide(), void 0) : (this.search.form.submit(), void 0)
        }, suggest: function (e) {
            var i = this, n = {
                click: function (e) {
                    e.preventDefault(), i.done(t(this).parent())
                }
            };
            this.options.msgResultsHeader && t("<li>").addClass(this.options.resultsHeaderClass + " " + this.options.skipClass).html(this.options.msgResultsHeader).appendTo(this.search.dropdown), e.results && e.results.length > 0 ? (t(e.results).each(function () {
                var e = t('<li><a href="#">' + this.title + "</a></li>").data("choice", this);
                this.text && e.find("a").append("<div>" + this.text + "</div>"), i.search.dropdown.append(e)
    ...
    }, n.addRenderer("default", o), e.search = n, t(document).on("focus.search.uikit", "[data-uk-search]", function () {
        var i = t(this);
        i.data("search") || new n(i, e.Utils.options(i.attr("data-uk-search")))
    })
}(jQuery, jQuery.UIkit), function (t, e) {
    "use strict";
    var i = t(window), n = [], o = function () {
        ...
        if (!a.data("scrollspy")) {
            ...
            d(), this.element.data("scrollspy", this), this.check = d, n.push(this)
        }
    };
    s.defaults = {
    ...
    var a = [], r = function () {
        ...
        if (!s.data("scrollspynav")) {
            ...
            var r, u = [], c = this.element.find("a[href^='#']").each(function () {
                u.push(t(this).attr("href"))
            }), d = t(u.join(",")), h = this, f = function () {
                r = [];
                for (var t = 0; d.length > t; t++)e.Utils.isInView(d.eq(t), h.options) && r.push(d.eq(t));
                if (r.length) {
                    var n = i.scrollTop(), o = function () {
                        for (var t = 0; r.length > t; t++)if (r[t].offset().top >= n)return r[t]
                    }();
                    if (!o)return;
                    h.options.closest ? c.closest(h.options.closest).removeClass(h.options.cls).end().filter("a[href='#" + o.attr("id") + "']").closest(h.options.closest).addClass(h.options.cls) : c.removeClass(h.options.cls).filter("a[href='#" + o.attr("id") + "']").addClass(h.options.cls)
                }
            };
            this.options.smoothscroll && e.smoothScroll && c.each(function () {
                new e.smoothScroll(this, h.options.smoothscroll)
            }), f(), this.element.data("scrollspynav", this), this.check = f, a.push(this)
        }
    };
    l.defaults = {cls: "uk-active", closest: !1, topoffset: 0, leftoffset: 0, smoothscroll: !1}, e.scrollspynav = l;
    var u = function () {
        o(), r()
    };
    ...
    var i = function (e, n) {
        ...
        s.data("smoothScroll") || (this.options = t.extend({}, i.defaults, n), this.element = s.on("click", function () {
            var e = t(this.hash).length ? t(this.hash) : t("body"), i = e.offset().top - o.options.offset, n = t(document).height(), s = t(window).height();
            return e.outerHeight(), i + s > n && (i = n - s), t("html,body").stop().animate({scrollTop: i}, o.options.duration, o.options.transition), !1
    ...
    e.extend(n.prototype, {
        ...
        target: !1,
        cls: "uk-hidden"
    }, i.toggle = n, e(document).on("click.toggle.uikit", "[data-uk-toggle]", function () {
        var t = e(this);
        t.data("toggle") || (new n(t, i.Utils.options(t.attr("data-uk-toggle"))), t.trigger("click"))
    })
