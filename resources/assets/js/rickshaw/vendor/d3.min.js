(function () {
    ...
    function bn(a, b, c) {
        h(a, br);
        var d = {}, e = d3.dispatch("start", "end"), f = bu;
    ...
    function bM(a, b, c, d) {
        function g() {
            var g = a.length == 2 ? bS : bT, i = d ? Q : P;
    ...
    function bP(a, b) {
        var c = bJ(a), d = c[1] - c[0], e = Math.pow(10, Math.floor(Math.log(d / b) / Math.LN10)), f = b / d * e;
    ...
    function bU(a, b) {
        ...
        return d.invert = function (b) {
            ...
            var d = bJ(a.domain()), e = [];
            if (d.every(isFinite)) {
                var f = Math.floor(d[0]), g = Math.ceil(d[1]), h = Math.round(c(d[0])), i = Math.round(c(d[1]));
                if (b === bX) {
                    e.push(c(f));
            ...
            var f = a / d.ticks().length, g = b === bX ? (h = -1e-15, Math.floor) : (h = 1e-15, Math.ceil), h;
            return function (a) {
    ...
    function b$(a, b) {
        ...
        return f.domain = function (d) {
            ...
            arguments.length < 2 && (h = 0);
            var i = c[0], j = c[1], k = (j - i) / (a.length + h);
            return d = g(i + k * h, k), e = k * (1 - h), b = {t: "rangeBands", x: c, p: h}, f
        }, f.rangeRoundBands = function (c, h) {
            arguments.length < 2 && (h = 0);
            var i = c[0], j = c[1], k = Math.floor((j - i) / (a.length + h));
    ...
    function cl(a) {
        ...
        var b = cn, c = co, d = "linear", e = cp[d], f = .7;
    ...
    function cI(a) {
        var b = 0, c = a.length - 1, d = [], e = a[0], f = a[1], g = d[0] = cH(e, f);
        while (++b < c)d[b] = g + (g = cH(e = f, f = a[b + 1]));
        return d[b] = g, d
    }

    function cJ(a) {
        var b = [], c, d, e, f, g = cI(a), h = -1, i = a.length - 1;
    ...
    function cM(a) {
        function j(f) {
            ...
            var j = cm(this, f, b, d), k = cm(this, f, b === c ? cN(j) : c, d === e ? cO(j) : e);
            return "M" + g(a(k), i) + "L" + h(a(j.reverse()), i) + "Z"
        }

        var b = cn, c = cn, d = 0, e = co, f, g, h, i = .7;
    ...
    function cV(a) {
        return function () {
            var b = a.apply(this, arguments), c = b[0], d = b[1] + cf;
    ...
    function dd(a, b, c) {
        e = [];
        if (c && b.length > 1) {
            var d = bJ(a.domain()), e, f = -1, g = b.length, h = (b[1] - b[0]) / ++c, i, j;
    ...
    function dt() {
        if (dn) {
            var a = d3.svg.mouse(dg), b = d3.select(dg);
    ...
    function du(a, b, c) {
        var d = bJ(b.range()), e = dn[c], f = dj[1][c] - dj[0][c], g, h;
    ...
    function dE(a) {
        var b = d3.event, c = dz.parentNode, d = 0, e = 0;
    ...
    function dY() {
        var a = d3.svg.touches(dS), b = -1, c = a.length, d;
    ...
    function dZ() {
        ...
        switch (a.length) {
            case 1:
                ...
                break;
            case 2:
                var c = a[0], d = a[1], e = [(c[0] + d[0]) / 2, (c[1] + d[1]) / 2], f = dM[c.identifier], g = dM[d.identifier], h = [(f[0] + g[0]) / 2, (f[1] + g[1]) / 2, f[2]];
    ...
    function eb(a, b, c) {
        ...
        a = ed(a, 2);
        var d = Math.pow(2, dO[2]), e = Math.pow(2, a), f = Math.pow(2, (dO[2] = a) - c[2]), g = dO[0], h = dO[1], i = dO[0] = ed(b[0] - c[0] * f, 0, e), j = dO[1] = ed(b[1] - c[1] * f, 1, e), k = d3.event;
        d3.event = {
            scale: e, translate: [i, j], transform: function (a, b) {
                a && l(a, g, i), b && l(b, h, j)
            }
        };
        try {
    ...
    d3.round = function (a, b) {
        ...
        var a = new o, b = -1, c = arguments.length;
        ...
        var b = q.exec(a), c = b[1] || " ", d = b[3] || "", e = b[5], f = +b[6], g = b[7], h = b[8], i = b[9], j = 1, k = "", l = !1;
    ...
    d3.selection = function () {
        ...
        var c = a.split(bg), d = c.length, e = -1;
        if (arguments.length > 1) {
    ...
    var bo = {}, br = [], bs = 0, bt = 0, bu = d3.ease("cubic-in-out");
    ...
    var bG = document.createElementNS(d3.ns.prefix.svg, "g"), bH = 180 / Math.PI;
    ...
    d3.scale.quantile = function () {
        ...
        function e() {
            var e = a.apply(this, arguments), f = b.apply(this, arguments), g = c.apply(this, arguments) + cf, h = d.apply(this, arguments) + cf, i = (h < g && (i = g, g = h, h = i), h - g), j = i < Math.PI ? "0" : "1", k = Math.cos(g), l = Math.sin(g), m = Math.cos(h), n = Math.sin(h);
        ...
        return e.innerRadius = function (b) {
            ...
            var e = (a.apply(this, arguments) + b.apply(this, arguments)) / 2, f = (c.apply(this, arguments) + d.apply(this, arguments)) / 2 + cf;
            return [Math.cos(f) * e, Math.sin(f) * e]
        }, e
    };
    var cf = -Math.PI / 2, cg = 2 * Math.PI - 1e-6;
    ...
    var cp = {
        ...
        "cardinal-closed": cu,
        monotone: cK
    }, cD = [0, 2 / 3, 1 / 3, 0], cE = [0, 1 / 3, 2 / 3, 0], cF = [0, 1 / 6, 2 / 3, 1 / 6];
    d3.svg.line.radial = function () {
        ...
        function g(a, b, f, g) {
            var h = b.call(a, f, g), i = c.call(a, h, g), j = d.call(a, h, g) + cf, k = e.call(a, h, g) + cf;
        ...
        var a = d3.svg.diagonal(), b = cU, c = a.projection;
    ...
    var c_ = Math.sqrt(3), da = Math.tan(30 * Math.PI / 180);
    d3.svg.axis = function () {
        function j(j) {
            j.each(function (k, l, m) {
                var n = d3.select(this), o = j.delay ? function (a) {
                    var b = bt;
                    try {
                ...
                } : Object, p = a.ticks.apply(a, g), q = h == null ? a.tickFormat.apply(a, g) : h, r = dd(a, p, i), s = n.selectAll(".minor").data(r, String), t = s.enter().insert("svg:line", "g").attr("class", "tick minor").style("opacity", 1e-6), u = o(s.exit()).style("opacity", 1e-6).remove(), v = o(s).style("opacity", 1), w = n.selectAll("g").data(p, String), x = w.enter().insert("svg:g", "path").style("opacity", 1e-6), y = o(w.exit()).style("opacity", 1e-6).remove(), z = o(w).style("opacity", 1), A, B = bJ(a.range()), C = n.selectAll(".domain").data([0]), D = C.enter().append("svg:path").attr("class", "domain"), E = o(C), F = this.__chart__ || a;
        ...
        function e(a) {
            ...
            a.each(function () {
                var a = d3.select(this).on("mousedown.brush", f), h = a.selectAll(".background").data([,]), i = a.selectAll(".extent").data([,]), j = a.selectAll(".resize").data(g, String), k;
        ...
        var a = d3.dispatch("brushstart", "brush", "brushend"), b, c, d = [[0, 0], [0, 0]];
    ...
    var dJ, dK, dL, dM = {}, dN = 0, dO, dP, dQ, dR, dS, dT, dU, dV, ec = [[-Infinity, Infinity], [-Infinity, Infinity], [-Infinity, Infinity]]
})();