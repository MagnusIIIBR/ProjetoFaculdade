...
(function () {
    ...
    function u() {
        ...
        G = setTimeout(function () {
            if ("localStorage" == k || "globalStorage" == k)a = h.jStorage_update; else if ("userDataBehavior" == k) {
                d.load("jStorage");
                try {
            ...
            if (a && a != r) {
                r = a;
                var l = m.parse(m.stringify(c.__jstorage_meta.CRC32)), p;
                D();
    ...
    function s(a, b) {
        ...
        for (var p = a.length; c < p; c++) {
            if (g[a[c]])for (var e = 0, d = g[a[c]].length; e < d; e++)g[a[c]][e](a[c], b);
            if (g["*"])for (e = 0, d = g["*"].length; e < d; e++)g["*"][e](a[c], b)
        }
    }
    ...
    function w() {
        if (c.__jstorage_meta.PubSub) {
            ...
            l; b++)if (c.__jstorage_meta.PubSub[b][0] <= a) {
    ...
    function F() {
        ...
        if (c.__jstorage_meta.PubSub) {
            var b, l = B;
            for (a = c.__jstorage_meta.PubSub.length - 1; 0 <= a; a--)if (b = c.__jstorage_meta.PubSub[a],
                b[0] > B) {
                var l = b[0], d = b[1];
                b = b[2];
                if (t[d])for (var e = 0, h = t[d].length; e < h; e++)try {
    ...
    var y = window.jQuery || window.$ || (window.$ = {}), m = {
    ...
    y.jStorage = {
        version: "0.4.8", set: function (a, b, d) {
            q(a);
            d = d || {};
            if ("undefined" == typeof b)return this.deleteKey(a), b;
            if (C.isXML(b))b = {_is_xml: !0, xml: C.encode(b)}; else {
            ...
            q(a);
            if (g[a])if (b)for (var c = g[a].length - 1; 0 <= c; c--)g[a][c] == b && g[a].splice(c, 1); else delete g[a]
