...
(function (t) {
    ...
    function l(n, i) {
        ...
        function B() {
            ne.css({width: "100%", height: ne.height(), overflow: "hidden"})
        }

        function I() {
            ne.css({width: "", height: "", overflow: ""})
        }
        ...
        var te, ee, ne, ie, re, se, oe, le, ae = q.isFetchNeeded, ce = q.fetchEvents, de = n[0], ue = 0, he = [];
    ...
    function c(n) {
        ...
        function s(e, n) {
            o(e, function (i) {
                ...
                if (n == j) {
                    if (i)for (r = 0; i.length > r; r++)s = i[r], o = l ? s : S(s, e), o && q.push.apply(q, E(o));
                    X--, X || B(q)
                }
            })
        }
        ...
        function o(e, i) {
            ...
            if (a)t.isFunction(a) ? (y(), a.call(N, A.clone(), Y.clone(), n.timezone, function (t) {
                ...
                var c = e.url;
                if (c) {
                    var d, u = e.success, h = e.error, f = e.complete;
                    d = t.isFunction(e.data) ? e.data() : e.data;
                    var g = t.extend({}, d || {}), p = R(e.startParam, n.startParam), m = R(e.endParam, n.endParam), v = R(e.timezoneParam, n.timezoneParam);
        ...
        function g(t) {
            var e, n, i, r;
            for (e = 0; q.length > e; e++)if (n = q[e], n._id == t._id && n !== t)for (i = 0; U.length > i; i++)r = U[i], void 0 !== t[r] && (n[r] = t[r])
        }
        ...
        function E(e, n, i) {
            ...
            if (n = n || A, i = i || Y, e)if (e._recurring) {
        ...
        function D(t, e, n) {
            var i, r, s, o, l = t._allDay, a = t._start, c = t._end, d = !1;
        ...
        function T(e, i, r, s, o) {
            var l = N.getIsAmbigTimezone(), a = [];
            return t.each(e, function (t, e) {
                var c = e._allDay, u = e._start, h = e._end, f = null != r ? r : c, g = u.clone(), p = !i && h ? h.clone() : null;
        ...
        function k(t, e, i) {
            var r = t.source || {}, s = R(t.constraint, r.constraint, n.eventConstraint), o = R(t.overlap, r.overlap, n.eventOverlap);
            return L(e, i, s, o, t)
        }
        ...
        function L(t, e, n, i, r) {
            ...
            if (t = t.clone().stripZone(), e = e.clone().stripZone(), null != n) {
                for (s = z(n), o = !1, l = 0; s.length > l; l++)if (_(s[l], t, e)) {
                    o = !0;
                    break
                }
                if (!o)return !1
            }
            for (l = 0; q.length > l; l++)if (a = q[l], (!r || r._id !== a._id) && G(a, t, e)) {
                if (i === !1)return !1;
        ...
        function _(t, e, n) {
            var i = t.start.clone().stripZone(), r = N.getEventEnd(t).stripZone();
            return e >= i && r >= n
        }
        ...
        var A, Y, V = N.trigger, O = N.getView, B = N.reportEvents, I = N.getEventEnd, W = {events: []}, Z = [W], j = 0, X = 0, $ = 0, q = [];
    ...
    function p(e, n, i) {
        ...
        m(e), e.each(function (n, i) {
            var d = n === e.length - 1 ? s : r, u = t(i).outerHeight(!0);
            ...
            var i = e === o.length - 1 ? s : r, c = l[e], d = a[e], u = i - (c - d);
            i > c && t(n).height(u)
        })
    }
    ...
    function G(n, i, r) {
        var s, o, l, a, c = n[0], d = 1 == n.length && "string" == typeof c;
    ...
    function $(t) {
        for (var e, n = [], i = /\[([^\]]*)\]|\(([^\)]*)\)|(LT|(\w)\4*o?)|([^\w\[\(]+)/g; e = i.exec(t);)e[1] ? n.push(e[1]) : e[2] ? n.push({maybe: $(e[2])}) : e[3] ? n.push({token: e[3]}) : e[5] && n.push(e[5]);
        return n
    }
    ...
    function pe(t) {
        var e, n, i, r, s;
        for (e = 0; t.length > e; e++)for (n = t[e], i = 0; n.length > i; i++)for (r = n[i], r.forwardSegs = [], s = e + 1; t.length > s; s++)ye(r, t[s], r.forwardSegs)
    }
    ...
    function ve(t, e, n) {
        ...
        if (void 0 === t.forwardCoord)for (r.length ? (r.sort(Se), ve(r[0], e + 1, n), t.forwardCoord = r[0].backwardCoord) : t.forwardCoord = 1, t.backwardCoord = t.forwardCoord - (t.forwardCoord - n) / (e + 1), i = 0; r.length > i; i++)ve(r[i], 0, t.forwardCoord)
    }
    ...
    function be(n) {
        ...
        function g(t, e) {
            var n = C.colCnt, i = G ? -1 : 1, r = G ? n - 1 : 0;
        ...
        function S(t) {
            var e = C.colCnt, n = G ? -1 : 1, i = G ? e - 1 : 0, r = Math.floor(t / e), s = (t % e + e) % e * n + i;
            return {row: r, col: s}
        }

        function b(t, e) {
            for (var n = C.rowCnt, i = C.colCnt, r = [], s = E(t, e), o = y(s.start), l = y(s.end), a = w(o), c = w(l) - 1, d = 0; n > d; d++) {
                var u = d * i, h = u + i - 1, f = Math.max(a, u), g = Math.min(c, h);
                if (g >= f) {
                    var m = S(f), v = S(g), b = [m.col, v.col].sort(z), D = p(f) == o, T = p(g) + 1 == l;
                    r.push({row: d, leftCol: b[0], rightCol: b[1], isStart: D, isEnd: T})
                }
            }
            return r
        }
        ...
        var H = n.reportEventChange, x = n.options, k = e.duration(x.nextDayThreshold);
        ...
        var M, P = i("hiddenDays") || [], F = [], L = [], _ = [], G = i("isRTL");
        (function () {
    ...
    var Fe = {
        ...
        columnFormat: {month: "ddd", week: i, day: "dddd"},
    ...
    }, _e = t.fullCalendar = {version: "2.2.3"}, Ge = _e.views = {};
    t.fn.fullCalendar = function (e) {
        var n = Array.prototype.slice.call(arguments, 1), i = this;
        return this.each(function (r, s) {
            var o, a = t(s), c = a.data("fullCalendar");
        ...
        r || (r = Le[e] = {}), s(r, {
            ...
            titleFormat: {month: i.showMonthAfterYear ? "YYYY[" + i.yearSuffix + "] MMMM" : "MMMM YYYY[" + i.yearSuffix + "]"},
            defaultButtonText: {prev: F(i.prevText), next: F(i.nextText), today: F(i.currentText)}
    ...
    var Ne = {dataType: "json", cache: !1}, Ae = 1, Ye = ["sun", "mon", "tue", "wed", "thu", "fri", "sat"];
    _e.applyAll = M;
    var Ve, Oe, Be, Ie = /^\s*\d{4}-\d\d$/, We = /^\s*\d{4}-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?)?$/, Ze = e.fn, je = t.extend({}, Ze);
    _e.moment = function () {
        return G(arguments)
        ...
        var t = this.toArray(), e = this._ambigTime;
    ...
    q.prototype = {
        isHidden: !0, options: null, el: null, documentMousedownProxy: null, margin: 10, show: function () {
            ...
            var e, n, i, r, s, o = this.options, l = this.el.offsetParent().offset(), a = this.el.outerWidth(), c = this.el.outerHeight(), d = t(window), u = S(this.el);
        ...
        getCell: function (t, e) {
            var n, i = null, r = this.rows, s = this.cols, o = -1, l = -1;
            if (this.inBounds(t, e)) {
                ...
                o >= 0 && l >= 0 && (i = {row: o, col: l}, i.grid = this.grid, i.date = this.grid.getCellDate(i))
            }
            return i
        },
        ...
        view: null, cellHtml: "<td/>", rowHtml: function (t, e) {
            ...
            var i = this.view, r = this.getHtmlRenderer("intro", e)(n || 0), s = this.getHtmlRenderer("outro", e)(n || 0), o = i.opt("isRTL"), l = o ? s : r, a = o ? r : s;
        ...
        dayMousedown: function (t) {
            var e, n, i, r = this, s = this.view, o = s.calendar, l = s.opt("selectable"), a = null, c = new Q(this.coordMap, {
        ...
        fillSegHtml: function (t, e) {
            var n = this[t + "SegClasses"], i = this[t + "SegStyles"], r = n ? n.call(this, e) : [], s = i ? i.call(this, e) : "";
        ...
        getDayClasses: function (t) {
            var e = this.view, n = e.calendar.getNow().stripTime(), i = ["fc-" + Ye[t.day()]];
        ...
        bgEventSegStyles: function (t) {
            var e = this.view, n = t.event, i = n.source || {}, r = n.color, s = i.color, o = e.opt("eventColor"), l = n.backgroundColor || r || i.backgroundColor || s || e.opt("eventBackgroundColor") || o;
        ...
        segDragMousedown: function (t, e) {
            var n, i, r = this, s = this.view, o = s.calendar, l = t.el, a = t.event, c = new te(t.el, {
                parentEl: s.el,
                opacity: s.opt("dragOpacity"),
                revertDuration: s.opt("dragRevertDuration"),
                zIndex: 2
            }), d = new Q(s.coordMap, {
                distance: 5, scroll: s.opt("dragScroll"), listenStart: function (t) {
                    c.hide(), c.start(t)
                }, dragStart: function (e) {
                    r.triggerSegMouseout(t, e), r.isDraggingSeg = !0, s.hideEvent(a), s.trigger("eventDragStart", l[0], a, e, {})
                }, cellOver: function (e, l) {
                    var u = t.cellDate || d.origDate, h = r.computeDraggedEventDates(t, u, l);
        ...
        computeDraggedEventDates: function (t, e, n) {
            var i, r, s, o, l, a = this.view, c = t.event, d = c.start, u = a.calendar.getEventEnd(c);
        ...
        segResizeMousedown: function (t, e) {
            ...
            var i, r = this, s = this.view, o = s.calendar, l = t.el, a = t.event, c = a.start, d = s.calendar.getEventEnd(a), u = null;
            i = new Q(this.coordMap, {
                distance: 5, scroll: s.opt("dragScroll"), dragStart: function (e) {
        ...
        getEventSkinCss: function (t) {
            var e = this.view, n = t.source || {}, i = t.color, r = n.color, s = e.opt("eventColor"), o = t.backgroundColor || i || n.backgroundColor || r || e.opt("eventBackgroundColor") || s, l = t.borderColor || i || n.borderColor || r || e.opt("eventBorderColor") || s, a = t.textColor || n.textColor || e.opt("eventTextColor"), c = [];
        ...
        eventsToInverseRanges: function (t) {
            var e, n, i = this.view, r = i.start.clone().stripZone(), s = i.end.clone().stripZone(), o = this.eventsToNormalRanges(t), l = [], a = t[0], c = r;
            for (o.sort(le), e = 0; o.length > e; e++)n = o[e], n.start > c && l.push({
                event: a,
                start: c,
                end: n.start
            }), c = n.end;
            return s > c && l.push({event: a, start: c, end: s}), l
        },
        ...
        renderFillRow: function (e, n) {
            var i, r, s = this.view.colCnt, o = n.leftCol, l = n.rightCol + 1;
        ...
        rowStructs: null, destroyEvents: function () {
            ...
            var n, i = this.view, r = i.opt("isRTL"), s = t.event, o = i.isEventDraggable(s), l = !e && s.allDay && t.isEnd && i.isEventResizable(s), a = this.getSegClasses(t, o, l), c = this.getEventSkinCss(s), d = "";
            ...
            var r, s, o, l, a, c, d, u = this.view, h = u.colCnt, f = this.buildSegLevels(n), g = Math.max(1, f.length), p = t("<tbody/>"), m = [], v = [], y = [];
            for (r = 0; g > r; r++) {
                if (s = f[r], o = 0, l = t("<tr/>"), m.push([]), v.push([]), y.push([]), s)for (a = 0; s.length > a; a++) {
            ...
            return {row: e, tbodyEl: p, cellMatrix: v, segMatrix: m, segLevels: f, segs: n}
        ...
        segPopover: null, popoverSegs: null, destroySegPopover: function () {
            ...
            var e, n, i = this.rowEls.eq(t), r = i.height(), s = this.rowStructs[t].tbodyEl.children();
            for (e = 0; s.length > e; e++)if (n = s.eq(e).removeClass("fc-limited"), n.position().top + n.outerHeight() > r)return e;
            return !1
            ...
            var r, s, o, l, a, c, d, u, h, f, g, p, m, v, y, w, S = this, b = this.view, E = this.rowStructs[e], D = [], T = 0;
            ...
            return t('<a class="fc-more"/>').text(this.getMoreLinkText(n.length)).on("click", function (s) {
                var o = r.opt("eventLimitClick"), l = r.cellToDate(e), a = t(this), c = i.getCellDayEl(e), d = i.getCellSegs(e), u = i.resliceDaySegs(d, l), h = i.resliceDaySegs(n, l);
            ...
            var i, r = this.view, s = r.opt("theme"), o = e.format(r.opt("dayPopoverFormat")), l = t('<div class="fc-header ' + r.widgetHeaderClass + '">' + '<span class="fc-close ' + (s ? "ui-icon ui-icon-closethick" : "fc-icon fc-icon-x") + '"></span>' + '<span class="fc-title">' + P(o) + "</span>" + '<div class="fc-clear"/>' + "</div>" + '<div class="fc-body ' + r.widgetContentClass + '">' + '<div class="fc-event-container"></div>' + "</div>"), a = l.find(".fc-event-container");
            ...
            var i = t.map(e, function (t) {
                return t.event
            }), r = n.clone().stripTime(), s = r.clone().add(1, "days");
            return this.eventsToSegs(i, function (t, e) {
                var n = D(t, e, r, s);
                return n ? [n] : []
            })
        }, getMoreLinkText: function (t) {
            var e = this.view, n = e.opt("eventLimitText");
        ...
        buildCoords: function (n, i) {
            var r, s, o = this.view.colCnt, l = this.el.offset().top, a = e.duration(+this.minTime), c = null;
        ...
        renderFill: function (e, n, i) {
            ...
            if (n.length) {
                for (n = this.renderFillSegEls(e, n), r = this.groupSegCols(n), i = i || e.toLowerCase(), s = t('<div class="fc-' + i + '-skeleton">' + "<table><tr/></table>" + "</div>"), o = s.find("tr"), l = 0; r.length > l; l++)if (a = r[l], c = t("<td/>").appendTo(o), a.length)for (d = t('<div class="fc-' + i + '-container"/>').appendTo(c), u = g.cellToDate(0, l), h = 0; a.length > h; h++)f = a[h], d.append(f.el.css({
        ...
        eventSkeletonEl: null, renderFgSegs: function (e) {
            ...
            var n, i, r, s, o, l, a = t("<table><tr/></table>"), c = a.find("tr");
            ...
            var n, i, r, s = this.view, o = t.event, l = s.isEventDraggable(o), a = !e && t.isEnd && s.isEventResizable(o), c = this.getSegClasses(t, l, a), d = this.getEventSkinCss(o);
            ...
            var e, n, i = this.view, r = i.opt("isRTL"), s = i.opt("slotEventOverlap"), o = t.backwardCoord, l = t.forwardCoord, a = this.generateSegVerticalCss(t);
        ...
        computeScrollerHeight: function (t) {
            ...
            return n.css({
                position: "relative",
                left: -1
            }), e = this.el.outerHeight() - this.scrollerEl.height(), n.css({position: "", left: ""}), t - e
        },
        ...
        documentDragStart: function (e) {
            var n, i, r, s, o, l = this, a = this.calendar, c = null, d = null, u = null;
    ...
    }), r({fixedWeekCount: !0}), Ge.month = Te, Te.prototype = k(De.prototype), t.extend(Te.prototype, {
        name: "month",
