...
(window._gsQueue || (window._gsQueue = [])).push(function () {
    "use strict";
    var t = Math.PI / 180, e = function (t, e, i, r, s) {
    ...
    }, i = Math.random(), r = window._gsDefine.globals.com.greensock.core.Animation._rootFramesTimeline, s = window._gsDefine.plugin({
        propName: "physics2D",
        API: 2,
        init: function (i, s, n) {
        ...
        set: function () {
            var t, e, i, r, s, n, a = this._tween._time, o = this._x, l = this._y;
            if (this._runBackwards === !0 && (a = this._tween._duration - a), 1 === this._friction)i = .5 * a * a, t = o.start + (o.velocity * a + o.acceleration * i), e = l.start + (l.velocity * a + l.acceleration * i); else {
                if (a *= this._stepsPerTimeUnit, r = n = (0 | a) - this._step, s = a % 1, n >= 0)for (; --n > -1;)o.v += o.a, l.v += l.a, o.v *= this._friction, l.v *= this._friction, o.value += o.v, l.value += l.v; else for (n = -n; --n > -1;)o.value -= o.v, l.value -= l.v, o.v /= this._friction, l.v /= this._friction, o.v -= o.a, l.v -= l.a;
    ...
    n._kill = function (t) {
        ...
        if (t) {
            var e = t._internals, r = e._parseToProxy, n = e._setPluginRatio, a = e.CSSPropTween;
            e._registerComplexSpecialProp("physics2D", {
                parser: function (t, e, o, l, h, u) {
                    u = new s;
                    var _, p = e.xProp || "x", f = e.yProp || "y", c = {};
