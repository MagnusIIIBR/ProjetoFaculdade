...
<body class="page-body login-page login-form-fall">
            ...
            <div class="login-content">
                ...
                <div class="form-login-error">
                    ...
                    <p>
                        Enter
                        <strong>demo</strong>/
                        <strong>demo</strong>as login and password.
                    </p>
                </div>
    ...
    <script src="<?php echo 'http://' . $_SERVER['HTTP_HOST'] ?>/resources/assets/js/jquery.validate.min.js"></script>
    <script src="<?php echo 'http://' . $_SERVER['HTTP_HOST'] ?>/resources/assets/js/neon-login.js"></script>
