                    ...
                    <div class="panel-body">
                        <form role="form" class="form-horizontal form-groups-bordered">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="field-1" placeholder="Digite a quantidade   ">
                                </div>
                            </div>
                            
                            <div class="form-group">
                                <label for="field-1" class="col-sm-3 control-label">Preço de venda</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="field-1" placeholder="Digite o preço de venda">
                                </div>
