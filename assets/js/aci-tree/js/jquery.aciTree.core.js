    ...
    var aciTree_core = {
        ...
        _options: function (object, _success, _fail, _notify, item) {
            ...
            var options = $.extend({
                    ...
                    itemData: {} // items data (object) or a list (array) of them (used when creating branches)
                },
                object);
        ...
        ajaxLoad: function (item, options) {
            ...
            if (!item || this.isInode(item)) {
                ...
                this._instance.queue.push(function (complete) {
                    ...
                    var settings = $.extend({}, this._dataSource(item));
        ...
        _createItem: function (itemData, level) {
            ...
            var $li = $(li);
            $li.data('itemData' + this._instance.nameSpace, $.extend({}, itemData, {
            ...
            if (this.isInode(item)) {
                ...
                if (this.wasLoad(item)) {
                    ...
                    this.children(item, false, true).each(this.proxy(function (element) {
                        ...
                        if (callback) {
                            entry = callback.call(this, $(element), {}, entry);
                        } else {
                            entry = this._instance.options.serialize.call(this, $(element), {}, entry);
                        }
                        if (entry) {
        ...
        serialize: function (item, what, callback) {
            ...
            if (typeof what == 'object') {
                if (item) {
                    ...
                    if (callback) {
                        data = callback.call(this, item, {}, data);
                    } else {
                        data = this._instance.options.serialize.call(this, item, {}, data);
                    }
                    return data;
                } else {
                    var list = [];
                    this.children(null, false, true).each(this.proxy(function (element) {
                        ...
                        if (callback) {
                            data = callback.call(this, $(element), {}, data);
                        } else {
                            data = this._instance.options.serialize.call(this, $(element), {}, data);
                        }
                        if (data) {
                            list.push(data);
                        }
