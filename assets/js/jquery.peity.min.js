...
(function (h, j, k, m) {
    ...
    i.register("line", {
        ...
        var d = k.max.apply(k, b.concat([a.max])), c = k.min.apply(k, b.concat([a.min])),
            f = this.prepareCanvas(a.width, a.height), e = this.context, l = f.width, f = f.height - a.strokeWidth, h = l / (b.length - 1), d = f / (d - c), n = [], g;
        e.beginPath();
        e.moveTo(0, f + c * d);
        for (g = 0; g < b.length; g++) {
            var i = g * h, j = f - d * (b[g] - c) + a.strokeWidth / 2;
            n.push({x: i, y: j});
            e.lineTo(i, j)
        }
        e.lineTo(l, f + c * d);
    ...
    i.register("bar", {
        colours: ["#4D89F9"],
        delimiter: ",", height: 16, max: null, min: 0, spacing: m, width: 32
    }, function (a) {
