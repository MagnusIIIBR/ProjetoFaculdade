...
(window._gsQueue || (window._gsQueue = [])).push(function () {
    ...
    var t = function (e) {
        ...
        for (var i = e.length, s = ""; --t > -1;)s += e[0 | Math.random() * i];
        return s
    }, i = function (t) {
