...
(function (t) {
    "use strict";
    var e, i, s, r = t.fn.animate, n = t.fn.stop, a = !0, o = function (t, e) {
    ...
    t.fn.animate = function (s, n, o, l) {
        ...
        var u, p, m, d, g = t.speed(n, o, l), v = {ease: c[g.easing] || (g.easing === !1 ? c.linear : c.swing)}, T = this, y = "object" == typeof n ? n.specialEasing : null;
        for (p in s) {
        ...
        return m = function (i) {
            if (d)for (var s = d.length; --s > -1;)e.to(T, t.fx.off ? 0 : g.duration / 1e3, d[s]);
