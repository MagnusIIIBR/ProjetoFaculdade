                    ...
                    <div class="panel-body">
                        <form role="form" class="form-horizontal form-groups-bordered">
                            <div class="form-group">
                                <label for="field-1" class="col-sm-3 control-label">Data da venda</label>

                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="field-1" placeholder="Digite a data da venda">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="field-1" class="col-sm-3 control-label">Produtos</label>

                                <div class="col-sm-5">
                                    <textarea class="form-control autogrow" id="field-ta" placeholder="Lista de produtos" style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 48px;"></textarea>
                                    <button type="submit" class="btn btn-default">Adicionar produto</button></div>
                            </div>
                            <div class="form-group">
